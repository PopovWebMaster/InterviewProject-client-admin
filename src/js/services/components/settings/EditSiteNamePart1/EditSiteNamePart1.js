...
import './EditSiteNamePart1.scss';

//import { GLOBAL } from '../../../../CONSTANTS.js';

class EditSiteNamePart1 extends Component {
    constructor(props){
        super(props);
        this.state = {
        ...
        // начало настроек
        this.elem_className = 'editSiteNamePart1';              // <- здесь
        ...
        this.setResult = this.props.set_site_name_part_1_val;   // <- здесь 
...
export default EditSiteNamePart1;
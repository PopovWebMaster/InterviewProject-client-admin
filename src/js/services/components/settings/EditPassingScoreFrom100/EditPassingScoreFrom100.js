...
import './EditPassingScoreFrom100.scss';
//import { GLOBAL } from '../../../../CONSTANTS.js';

class EditPassingScoreFrom100 extends Component {
    constructor(props){
        super(props);
        this.state = {
        ...
        // начало настроек
        this.elem_className = 'editPassingScoreFrom100'; // <- здесь
        this.className_nameItem = 'nameItem_set';
        this.className_item = 'item_set';
        this.className_editItem = 'editItem_set';
        this.setResult = this.props.set_passing_score_from_100; // <- здесь
        // конец настроек
...
export default EditPassingScoreFrom100;